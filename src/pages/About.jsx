...
const About = () => {
  return (
    <div id='About' className='px-8 md:px-20 bg-gradient-to-b from-linearBlue/40 via-white to-linearBlue/40 dark:from-black dark:via-paleBlue/90 dark:to-black lg:py-0 py-20 text-center gap-5 lg:text-start flex lg:flex-row flex-col lg:gap-28 items-center'>
      <img
        data-aos="fade-down"
        data-aos-delay="1000"
